<%@ Page Title="" Language="C#" MasterPageFile="~/PagePrincipal.Master" AutoEventWireup="true" CodeBehind="Cliente.aspx.cs" Inherits="WebApplicationProjetoAula5.Cliente" %>
        ...
        <article class="kanban-entry grab" id="item1" draggable="true">
            <div class="kanban-entry-inner">
                <div class="kanban-label">
                    <h2><a href="#">Cadastro de Clientes</a> <span></span></h2>
                    <p></p>
                </div>
            </div>
        </article>
